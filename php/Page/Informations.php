...
use Page\Classes\sInformations;


if (
    isset($sessionUsr['userId'])
    && (int)$sessionUsr['canKnowledge'] > 0
) {
/** @var array $returnArray It stores the content to be displayed */
    $returnArray = array();
/** @var array $urlPaths Routing assistant variable*/
    $urlPaths = array(
        "Root"          => array("path" => "Informations",             "role" => "canInformations")
        ,"Knowledge"    => array("path" => "Informations/Knowledge",   "role" => "canKnowledge")
        ,"Passtorage"    => array("path" => "Informations/Passtorage",   "role" => "canPasstorage")
        ,"Access"    => array("path" => "Informations/Access",   "role" => "canAccess")
        ,"Device"          => array("path" => "Informations/Device",              "role" => "canHardware")
    );
