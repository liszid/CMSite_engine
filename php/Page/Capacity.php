...
if (isset($sessionUsr["userId"]) && (int) $sessionUsr["canLogin"] > 0) {
    $returnArray = [];
    $urlPaths = [
        "Root" => ["path" => "Capacity", "role" => "canLogin"],
        "Storage" => ["path" => "Capacity/Storage", "role" => "canLogin"],
        "Group" => ["path" => "Capacity/Group", "role" => "canLogin"],
    ];
    ...
    if (isset($_POST["y"]) && isset($_POST["z"])) {
        ...
        $postUrl = Check::isEither(["post" => ["y", "b"], "fallBack" => "Capacity"]);
