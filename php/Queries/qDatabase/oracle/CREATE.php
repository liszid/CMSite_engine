...
interface CREATE
{
     const CREATE = array(
        0 => "
            CREATE TABLE User (
               userId NUMBER(6) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
               userName VARCHAR2(32) NOT NULL UNIQUE,
               pWord VARCHAR2(32) NOT NULL,
               userFirstName VARCHAR2(64),
               userLastName VARCHAR2(64),
               userContEmail VARCHAR2(128) NOT NULL UNIQUE,
               userContPhone VARCHAR2(32),
               userContSite VARCHAR2(64),
        ...
        ,1 => "
            CREATE TABLE Group (
               groupId NUMBER(6) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
