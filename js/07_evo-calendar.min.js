...
!function(e) {
            ...
            i.initials = {
                ...
                dates: {
                    hu: {
                        ...
                        noEventForToday: "Nincs új esemény",
                        noEventForThisDay: "Nincs esemény",
                        previousYearText: "Előző év",
                        nextYearText: "Következő év",
                        closeSidebarText: "Sáv bezárása",
                        closeEventListText: "Esemény lista bezárása"
                    },
                    en: {
    ...
    t.prototype.addEventList = function(e) {
        ...
        t += "</div>",
        t += '<div class="btn-group" role="group"><a class="btn btn-danger" role="button" data-link="Plans/Calendar/Delete" data-post="' + e.id + '" data-target="#modalBox" data-placement="top" title="" data-original-title=""><i class="fa fa-trash" aria-hidden="true"></i></a></div>',
        t += "</div>",
        t += "</div>",
        n.append(t),
    ...
    ,
    t.prototype.addEventIndicator = function(e) { var t, a, n = this, i = e.date, o = n.stringCheck(e.type); if (i instanceof Array) { if (e.everyYear) for (var r = 0; r < i.length; r++) i[r] = n.formatDate(new Date(i[r]).setFullYear(n.$active.year), n.options.format); for (var s = n.getBetweenDates(i), l = 0; l < s.length; l++) d(s[l]) } else e.everyYear && (i = n.formatDate(new Date(i).setFullYear(n.$active.year), n.options.format)), d(i); function d(i) { 0 === (a = n.$elements.innerEl.find('[data-date-val="' + i + '"]')).find("span.event-indicator").length && a.append('<span class="event-indicator"></span>'), 0 === a.find("span.event-indicator > .type-bullet > .type-" + o).length && (t = '<div class="type-bullet"><div ', t += 'class="type-' + e.type + '"', e.color && (t += 'style="background-color:' + e.color + '"'), t += "></div></div>", a.find(".event-indicator").append(t)) } }
    ,
